...
```bash
go install github.com/CaliLuke/loom/cmd/loom@v1.10.0-alpha.1
```
...
```bash
go get -tool github.com/CaliLuke/loom/cmd/loom@v1.10.0-alpha.1
...
```bash
go get github.com/CaliLuke/loom/cmd/loom@v1.10.0-alpha.1
