...
```bash
go install github.com/CaliLuke/loom/cmd/loom@v1.9.0-alpha.3
```
...
```bash
go get -tool github.com/CaliLuke/loom/cmd/loom@v1.9.0-alpha.3
...
```bash
go get github.com/CaliLuke/loom/cmd/loom@v1.9.0-alpha.3
