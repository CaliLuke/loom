...
type (
	// Observer receives transport lifecycle events emitted by generated code.
...
// single entry point generated code uses to emit events so that a missing
// observer remains a cheap no-op.
