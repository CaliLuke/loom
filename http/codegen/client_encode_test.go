...
func TestClientEncode(t *testing.T) {
	cases := []struct {
		...
		{"form-body-object", testdata.PayloadFormBodyObjectDSL},
		{"form-body-object-optional", testdata.PayloadFormBodyObjectOptionalDSL},
		{"form-body-invalid", testdata.PayloadFormBodyInvalidDSL},
		{"form-body-union", testdata.PayloadFormBodyUnionDSL},
