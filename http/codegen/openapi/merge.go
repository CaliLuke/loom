...
func (s *Schema) createMergeItems(other *Schema) mergeItems {
	...
	return mergeItems{
		...
		{&s.WriteOnly, other.WriteOnly, !s.WriteOnly},
		{&s.Deprecated, other.Deprecated, !s.Deprecated},
		{&s.ContentEncoding, other.ContentEncoding, s.ContentEncoding == ""},
		{&s.ContentMediaType, other.ContentMediaType, s.ContentMediaType == ""},
