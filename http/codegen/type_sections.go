...
func writeHTTPUnionTypeScaffold(b *strings.Builder, data *servicecodegen.UnionTypeData) {
...
func writeHTTPUnionVariantMethods(b *strings.Builder, data *servicecodegen.UnionTypeData) {
	for _, field := range data.Fields {
...
func writeHTTPUnionValidationMethods(b *strings.Builder, data *servicecodegen.UnionTypeData) {
...
func writeHTTPUnionMarshalJSONMethod(b *strings.Builder, data *servicecodegen.UnionTypeData) {
...
func writeHTTPUnionUnmarshalJSONMethod(b *strings.Builder, data *servicecodegen.UnionTypeData) {
...
func writeHTTPUnionFormMethods(b *strings.Builder, data *servicecodegen.UnionTypeData) {
