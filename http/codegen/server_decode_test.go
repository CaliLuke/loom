...
func TestDecode(t *testing.T) {
	cases := []struct {
		...
		{"decode-form-body-object", testdata.PayloadFormBodyObjectDSL},
		{"decode-form-body-object-optional", testdata.PayloadFormBodyObjectOptionalDSL},
		{"decode-form-body-invalid", testdata.PayloadFormBodyInvalidDSL},
		{"decode-form-body-union", testdata.PayloadFormBodyUnionDSL},
