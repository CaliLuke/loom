...
Still open: S-7 CI caching, the Windows integration-coverage decision (explicitly deferred), the V-3 golden-migration/V-5 cross-tree dedup remainder, and the issue backlog above.
