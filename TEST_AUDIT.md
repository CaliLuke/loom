...
Still open: S-7 CI caching, C-5 (pulse Redis-backed runtime), C-6 (jsonrpc decoder_sections), C-8 (codegen error-path tests), C-10 (`-race` CI variant), and the V-3/V-5 consolidation work.
