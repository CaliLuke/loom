...
type (
	...
	ServiceData struct {
		...
		// Name is the protocol buffer service name.
		Name string
		// GoName is the Go name that protoc-gen-go derives from Name.
		GoName string
		// protoMessages maps the names of the top-level generated messages to
		// the method and fields that defined them first.
		protoMessages map[string]protoMessageShape
	...
	EndpointData struct {
		...
		ServiceName string
		// RPCName is the protocol buffer rpc name.
		RPCName string
