...
and client code that wraps the Loom-generated endpoints with the protocol buffer
...
types to the Loom-generated types as follows:
  ...
  - It generates encoders and decoders that transforms the protocol buffer types and gRPC metadata into Loom types and vice versa.
