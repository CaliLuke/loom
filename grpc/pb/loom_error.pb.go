...
// 	protoc        v7.34.0
// source: loom_error.proto

// NOTE: If there are any changes to this file, run the protoc command as
// below from the pb directory to generate the loom_error.pb.go file.
//
// $  protoc --proto_path=. --go_out=. --go_opt=paths=source_relative  loom_error.proto
...
func (x *ErrorResponse) Reset() {
	*x = ErrorResponse{}
	mi := &file_loom_error_proto_msgTypes[0]
...
func (*ErrorResponse) Descriptor() ([]byte, []int) {
	return file_loom_error_proto_rawDescGZIP(), []int{0}
}
...
func (x *ErrorField) Reset() {
	*x = ErrorField{}
	mi := &file_loom_error_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ErrorField) Descriptor() ([]byte, []int) {
	return file_loom_error_proto_rawDescGZIP(), []int{1}
}
...
var File_loom_error_proto protoreflect.FileDescriptor

const file_loom_error_proto_rawDesc = "" +
	"\n" +
	"\x10loom_error.proto\x12\x06loompb\"\xc1\x01\n" +
	...
	"\ahistory\x18\a \x03(\v2\x12.loompb.ErrorFieldR\ahistory\"H\n" +
	"\n" +
	"ErrorField\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05field\x18\x02 \x01(\tR\x05field\x12\x10\n" +
	"\x03msg\x18\x03 \x01(\tR\x03msgB)Z'github.com/CaliLuke/loom/grpc/pb;loompbb\x06proto3"

var (
	file_loom_error_proto_rawDescOnce sync.Once
	file_loom_error_proto_rawDescData []byte
)

func file_loom_error_proto_rawDescGZIP() []byte {
	file_loom_error_proto_rawDescOnce.Do(func() {
		file_loom_error_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_loom_error_proto_rawDesc), len(file_loom_error_proto_rawDesc)))
	})
	return file_loom_error_proto_rawDescData
}

var file_loom_error_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_loom_error_proto_goTypes = []any{
	(*ErrorResponse)(nil), // 0: loompb.ErrorResponse
	(*ErrorField)(nil),    // 1: loompb.ErrorField
}
var file_loom_error_proto_depIdxs = []int32{
	1, // 0: loompb.ErrorResponse.history:type_name -> loompb.ErrorField
...
func init() { file_loom_error_proto_init() }
func file_loom_error_proto_init() {
	if File_loom_error_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_loom_error_proto_rawDesc), len(file_loom_error_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_loom_error_proto_goTypes,
		DependencyIndexes: file_loom_error_proto_depIdxs,
		MessageInfos:      file_loom_error_proto_msgTypes,
	}.Build()
	File_loom_error_proto = out.File
	file_loom_error_proto_goTypes = nil
	file_loom_error_proto_depIdxs = nil
}
