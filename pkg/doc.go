...
Compared to upstream Goa, Loom intentionally puts more weight on OpenAPI 3.1
quality, reusable public contract components, direct client-generation
compatibility, and framework-owned transport/auth glue that would otherwise be
reimplemented in applications. It was pushed in that direction in part to
support the creation of Auto-K and similar AI-assisted systems.
