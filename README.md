...
1.27rc2 or later. This preview requirement will move to Go 1.27 after its stable release.

Install the CLI and create a module:

```bash
go install github.com/CaliLuke/loom/cmd/loom@v1.8.0-alpha.12

mkdir hello && cd hello
go mod init example.com/hello
go get github.com/CaliLuke/loom@v1.8.0-alpha.12
mkdir design
```
