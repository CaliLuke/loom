...
// goHeaderVersionRE matches the generated header line that contains the Loom version (Go files).
var goHeaderVersionRE = regexp.MustCompile(`(?m)^// Code generated by Loom(?: v[^,]+)?, DO NOT EDIT\.`)

// protoHeaderVersionRE matches the generated header line that contains the Loom version (proto files).
var protoHeaderVersionRE = regexp.MustCompile(`(?m)^// Code generated with Loom(?: v[^,]+)?, DO NOT EDIT\.`)

// normalizeGoHeader replaces the versioned header with a version-agnostic placeholder.
func normalizeGoHeader(b []byte) []byte {
	return goHeaderVersionRE.ReplaceAll(b, []byte("// Code generated by Loom, DO NOT EDIT."))
}
...
func normalizeProtoHeader(b []byte) []byte {
	return protoHeaderVersionRE.ReplaceAll(b, []byte("// Code generated with Loom, DO NOT EDIT."))
}
