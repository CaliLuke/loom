...
func writeUnionTypeScaffold(b *strings.Builder, data *UnionTypeData) {
...
func writeUnionVariantMethods(b *strings.Builder, data *UnionTypeData) {
	for _, field := range data.Fields {
...
func writeUnionValidationMethods(b *strings.Builder, data *UnionTypeData) {
...
func writeUnionMarshalJSONMethod(b *strings.Builder, data *UnionTypeData) {
...
func writeUnionUnmarshalJSONMethod(b *strings.Builder, data *UnionTypeData) {
...
func writeUnionFormMethods(b *strings.Builder, data *UnionTypeData) {
